...
chrome_options.add_argument("--headless")  # Mode headless pour CI (retirez si vous souhaitez voir le navigateur)
...
for request in driver.requests:
    # On vérifie si la réponse existe et si l'URL est exactement celle recherchée (en normalisant les éventuels "/" en fin)
